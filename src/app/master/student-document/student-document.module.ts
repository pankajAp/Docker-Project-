...
import {StudentDocumentsService} from "./all-student-documents/student-documents.service";
import {AllStudentDocumentsComponent} from "./all-student-documents/all-student-documents.component";
import {FormDialogComponent} from "./all-student-documents/dialogs/form-dialog/form-dialog.component";
import {DeleteDialogComponent} from "./all-student-documents/dialogs/delete/delete.component";

// import { AddActionRescheduleComponent } from "./add-master-role-schedule/add-master-role-schedule.component";
// import { OwlDateTimeModule, OwlNativeDateTimeModule } from "ng-pick-datetime";
@NgModule({
  declarations: [
    AllStudentDocumentsComponent,
    FormDialogComponent,
    DeleteDialogComponent,
    AddStudentDocumentComponent,
    EditStudentDocumentComponent,
    // AboutStaffComponent,
  ],
  imports: [
    CommonModule,
