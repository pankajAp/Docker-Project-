...
import {ExampleDataSource} from "../../all-doc-material-status.component";
...
export class FormDialogComponent {
  ...
  constructor(
    ...
    if (this.action === 'edit') {
      ...
      this.dialogTitle = 'New Material Status';
  ...
  createEditActionForm(): FormGroup {
    return this.fb.group({
      dmsId: [this.doaAmounts.dmsId],
      dmsName: [this.doaAmounts.dmsName, [Validators.required]]
    });
  }
    ...
    this.api.add('mst_doc_material_status', data).subscribe(resp => {
      ...
      if (resp) {
        ...
        this.router.navigateByUrl('/RefreshComponent', {skipLocationChange: true}).then(() => {
          this.router.navigate(['master/doc-material-status/all-doc-material-status']);
        });
      } else {
