...
@Component({
  ...
  templateUrl: './edit-student-document-fee-category.component.html',
  styleUrls: ['./edit-student-document-fee-category.component.sass'],
})
export class EditStudentDocumentFeeCategoryComponent {
