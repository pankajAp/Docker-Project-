...
@Component({
  ...
  styleUrls: ['./all-modules.component.sass'],
})
export class AllModulesComponent implements OnInit {
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<Modules>(true, []);
    });
    this.showNotification(
      'snackbar-danger',
  ...
  public loadData() {
    this.exampleDatabase = new ModulesService(this.httpClient);
  ...
  // context menu
  onContextMenu(event: MouseEvent, item: Modules) {
...
export class ExampleDataSource extends DataSource<Modules> {
  ...
  renderedData: Modules[] = [];

  constructor(
    public exampleDatabase: ModulesService,
  ...
  sortData(data: Modules[]): Modules[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        case 'moduleId':
          [propertyA, propertyB] = [a.moduleId, b.moduleId];
          break;
        case 'moduleName':
